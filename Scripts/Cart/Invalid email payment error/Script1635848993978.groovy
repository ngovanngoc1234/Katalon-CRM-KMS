...
WebUI.callTestCase(findTestCase('Sub-Test Cases/Selected List Product'), [:], FailureHandling.STOP_ON_FAILURE)

'Enter email address'
WebUI.setText(findTestObject('Cart Page/txt_email'), 'ngoc@2014')

'Switch to iframe payment'
WebUI.switchToFrame(findTestObject('Cart Page/fra_payment'), 5)
